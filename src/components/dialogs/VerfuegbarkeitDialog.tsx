...
export function VerfuegbarkeitDialog({ open, onClose, onSubmit, defaultValues, mitarbeiterList, enablePhotoScan = true, enablePhotoLocation = true }: VerfuegbarkeitDialogProps) {
  ...
  async function handleAiExtract(file?: File) {
    ...
    try {
      ...
      const schema = `{\n  "mitarbeiter": string | null, // Display name from Mitarbeiter (see <available-records>)\n  "datum": string | null, // YYYY-MM-DD\n  "verfuegbarkeitsstatus": LookupValue | null, // Verfügbarkeitsstatus (select one key: "verfuegbar" | "nicht_verfuegbar" | "eingeschraenkt_verfuegbar") mapping: verfuegbar=Verfügbar, nicht_verfuegbar=Nicht verfügbar, eingeschraenkt_verfuegbar=Eingeschränkt verfügbar\n  "notizen": string | null, // Notizen\n}`;
    ...
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="verfuegbarkeitsstatus">Verfügbarkeitsstatus</Label>
            <Select
