...
const VERFUEGBARKEIT_FIELDS = [
  ...
  { key: 'verfuegbarkeitsstatus', label: 'Verfügbarkeitsstatus', type: 'lookup/select', options: [{ key: 'verfuegbar', label: 'Verfügbar' }, { key: 'nicht_verfuegbar', label: 'Nicht verfügbar' }, { key: 'eingeschraenkt_verfuegbar', label: 'Eingeschränkt verfügbar' }] },
...
const SCHICHTZUWEISUNGEN_FIELDS = [
  ...
  { key: 'tatsaechliche_startzeit', label: 'Tatsächliche Startzeit (falls abweichend)', type: 'string/text' },
  { key: 'tatsaechliche_endzeit', label: 'Tatsächliche Endzeit (falls abweichend)', type: 'string/text' },
